...
/**
 * An asynchronous event that supports cancellation.
 *
 * <p>Extends {@link CustomAsyncEvent} with cancellation semantics provided by
 ...
 * and callers can inspect the result post-dispatch through the
 * {@link java.util.concurrent.CompletableFuture} returned by
 * {@link io.github.trae.hytale.framework.utility.UtilEvent#supplyAsynchronous(com.hypixel.hytale.event.IAsyncEvent)}.</p>
 *
 * @see CustomCancellableEvent
 */
@Getter
public class CustomCancellableAsyncEvent extends CustomAsyncEvent implements ICustomCancellableEvent {
